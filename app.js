document.addEventListener("DOMContentLoaded", () => {
    ...
    const projets = [
      {
        ...
        technos: "HTML, CSS",
        description: "Dans ce projet, j'ai du développer un site vitrine à partir d'une maquette Figma, le site devait être responsive et le code devait être passé aux validateurs W3C.",
      ...
      },
      {
        ...
        objectifs: "Objectifs du projet",
        technos: "Javascript",
        description: "Dans ce projet, j'ai du développer pour une architecte d'intérieur : une page de présentation, une page de connexion de l'administrateur du site et une modale permettant à Sophie de pouvoir ajouter ou supprimer de nouveaux travaux.",
        lien: "https://github.com/ton-projet/booky"
      },
      {
        ...
        description: "Dans ce projet, j'ai du optimiser le référencement (SEO) du site de Nina Carducci, en utilisant l'outil Lighthouse, afin de mieux cerner les différentes optimisations à effectuer",
        lien: "https://github.com/ton-projet/booky"
      },
      {
      ...
      },
      {
        ...
        description: "Dans ce projet, j'ai du crée un serveur et un routeur grâce au framework Express et paramétrer la base de données MongoDB grâce à la bibliothèque Mongoose. J'ai créé différents middlewares pour l'authentification, la gestion des requêtes multipart et pour le retraitement des images (green code). Enfin grâce aux méthodes HTTP, j'ai créé différents controleurs pour manipuler la base de données.",
        lien: "https://github.com/ton-projet/booky"
      }
  ...
  <div class="modal-content">
    ...
    <p id="modal-subtitle" class="modal-subtitle">Projet professionnel ou personnel</p>
    ...
    function afficherProjets(listeProjets) {
      ...
      listeProjets.forEach((projet) => {
        ...
        projetDiv.addEventListener("click", () => {
          ...
          document.getElementById("modal-subtitle").textContent = "Site vitrine professionnel"; // Tu peux personnaliser ici
